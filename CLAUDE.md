...
- **Phase 1 — Auth & RBAC, hoàn thành và đã ở thẳng trên `main`** (làm trực tiếp trên `main`, không qua branch riêng — quyết định của user 2026-07-17). Chi tiết đầy đủ ở rule [15 · Auth & RBAC](.claude/rules/15-auth-rbac.md) — phần dưới đây tóm tắt đã code gì:
