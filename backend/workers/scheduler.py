...
# module này), chuỗi continuous_crawl -> report_job -> celery_app -> scheduler sẽ chạy
# TRƯỚC KHI continuous_crawl kịp định nghĩa xong crawl_task ở cuối file. Import module
